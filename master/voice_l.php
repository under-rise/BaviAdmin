    ...
    <!--page_info END-->
            ...
            <div class="table type02">
              ...
              <dl class="head">
                ...
                <dt class="w10"><a href="#" onClick="alert('ソート機能予定'); return false">表示 ▼</a></dt>
                <dt class="w10 lg">編集</dt>
              </dl>

              <dl>
                <dd class="w5"><a href="https://bavi.jp/spot/detail/335" target="_blank">1</a></dd>
                <dd class="w30"><a href="voice_edit.php">会場名</a></dd>
                <dd class="w30">投稿者</dd>
                <dd class="w15 lg">2021.10.31</dd>
                <dd class="w10"><a href="#" onClick="alert('表示切り替え予定'); return false" class="on">表示中</a></dd>
                <dd class="w10 lg"><a href="voice_edit.php" class="btn type02 mg_b5 edit">編集</a><a href="https://bavi.jp/spot/detail/335" target="_blank"class="btn type02 preview">プレビュー</a></dd>
              </dl>

              <dl>
                <dd class="w5"><a href="https://bavi.jp/spot/detail/335" target="_blank">2</a></dd>
                <dd class="w30"><a href="voice_edit.php">成田スカイウェイBBQ</a></dd>
                <dd class="w30">Bavi管理人</dd>
                <dd class="w15 lg">2021.10.31</dd>
                <dd class="w10"><a href="#" onClick="alert('表示切り替え予定'); return false" class="off">非表示</a></dd>
                <dd class="w10 lg"><a href="voice_edit.php" class="btn type02 mg_b5 edit">編集</a><a href="https://bavi.jp/spot/detail/335" target="_blank"class="btn type02 preview">プレビュー</a></dd>
              </dl>
