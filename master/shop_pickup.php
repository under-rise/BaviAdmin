...
<head>
  ...
  <title>ピックアップSPOT | Bavi 運営側管理ページ</title>
  ...
  <link rel="stylesheet" href="/css/page.css?1.4">
...
<body>
  ...
  <div class="oneColumn itemBOX shadow">
    ...
    <div class="ttl bg_purple">
      <h2><i class="fas fa-store purple"></i>ピックアップSPOT</h2>
    ...
    <div class="page_info">
    <p>食材SPOTトップページのピックアップ登録・編集ページ</p>
    </div>
    <!--page_info END-->
