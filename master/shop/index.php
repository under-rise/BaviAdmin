  ...
  <div id="container" class="">
    ...
    <div id="detail_top" class="top flex justify-between">
      ...
      <div class="base_info itemBOX shadow">
          ...
          <h2><i class="fas fa-home red"></i>店舗情報</h2>
          <a href="/master/shop/base.php?page=spot" class="btn type01">編集する</a>
          </div>
          ...
          <div class="inr">
            ...
            <a href="/master/shop/base.php?page=shop" class="btn type03">基本設定</a>

            <!-- <a href="/master/spot/corona.php?page=shop" class="btn type03">コロナ対策設定</a> -->
          </div>
      ...
      <div class="main_info itemBOX shadow">
          ...
          <a href="/master/shop/display.php?page=shop" class="btn type01">編集する</a>
          </div>
             ...
             <div class="txt">
              ...
              <div class="img">
                  <div class="sliderArea">
                      <div class="slider">
                        <div><img src="/images/storage/shop_main.jpg" ></div>
                        <div><img src="/images/storage/shop_main.jpg" ></div>
          ...
          <!-- flex END -->
            ...
            <a href="/master/shop/display.php?page=shop" class="btn type03">表示設定</a>
      ...
      <div class="main_info itemBOX shadow">
        <div class="ttl bg_orange">
          <h2><i class="fas fa-shopping-cart orange"></i>メニュー情報</h2>
          <a href="/master/shop/menu.php?page=shop" class="btn type01">編集する</a>
        </div>
        ...
        <div class="inr">
          ...
          <div class="slider">
            <div class="top_menu_info">
              <div class="txt">
                <dl>
                  <dt class="mg_b5">バーベキュー道具5人前セット</dt>
                  <dd>バーベキューに必要な道具セットが揃っています。これをレンタルすれば、バーベキューが楽しめます。</dd>
                  <dd class="price">¥3,000円</dd>
                </dl>
              </div>

              <div class="img">
                 <div><img src="/images/storage/menu.jpg"></div>
              </div>
            </div>
            <!-- top_menu_info END -->
        ...
        <a href="/master/shop/menu.php?page=shop" class="btn type03">編集する</a>
      ...
      <div class="cupon_info itemBOX shadow">
        ...
        <div class="table type01">
            ...
            <dl>
              ...
              <dd class="w50"><a href="/master/spot/coupon_edit.php?page=shop" class="under-line">ビールプレンゼント！</a></dd>
              <dd class="w10"><a href="/master/spot/coupon_edit.php?page=shop" class="btn type02">編集</a></dd>
            </dl>

            <dl>
              <dd class="w20">2021年10月1日</dd>
              <dd class="w20">割引型</dd>
              <dd class="w50"><a href="/master/spot/coupon_edit.php?page=shop" class="under-line">100%OFF!</a></dd>
              <dd class="w10"><a href="/master/spot/coupon_edit.php?page=shop" class="btn type02">編集</a></dd>
            </dl>
          ...
          <a href="/master/spot/coupon_l.php?page=shop" class="btn type03">クーポン一覧</a>
      ...
      <div class="itemBOX shadow">
        <div class="ttl bg_yellow">
          ...
          <a href="/master/news_edit.php?page=shop&user=on" class="btn type01">新規追加</a>
        </div>
        ...
        <div class="inr">
          ...
          <div class="table type01">
            <dl>
              ...
              <dd class="w70"><a href="/master/news_edit.php?page=shop&user=on" class="under-line">NEWS!!東京BBQ場所</a></dd>
              <dd class="w10"><a href="/master/news_edit.php?page=shop&user=on" class="btn type02">編集</a></dd>
            </dl>
          ...
          <!-- table -->
          <a href="/master/news_l.php?page=shop" class="btn type03">NEWS配信一覧</a>
