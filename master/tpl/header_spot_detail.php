  ...
  <div id="spMainBtn">
    ...
    <div class="nav">
      ...
      <ul class="mainBtn detail_link_sec">
        <li><a href="/master/spot/?page=spot"><i class="fas fa-th"></i>ダッシュボード</a></li>
        <li class="sub_nav"><a><i class="fas fa-home"></i>会場情報</a>
          <ul style="display: none;">
            <li><a href="/master/spot/base.php?page=spot">基本設定</a></li>
            <li><a href="/master/spot/corona.php?page=spot">コロナ対策設定</a></li>
          </ul>
        </li>

        <li class="sub_nav"><a><i class="fas fa-mobile-alt"></i>表示設定</a>
          <ul style="display: none;">
          <li><a href="/master/spot/display.php?page=spot">基本表示設定</a></li>
          <li><a href="/master/spot/spots.php?page=spot">食材SPOTリンク</a></li>
          </ul>
        </li>

       

        <li><a href="/master/spot/stand.php?page=spot"><i class="fas fa-shopping-cart"></i>売店情報</a></li>
        <li><a href="/master/spot/coupon_l.php?page=spot"><i class="fas fa-ticket-alt"></i>クーポン発行</a></li>
        <li><a href="/master/news_l.php?page=spot"><i class="fas fa-rss"></i>NEWS配信</a></li>
        <li><a href="/master/guest/voice_l.php?page=spot"><i class="fas fa-comment"></i>口コミ</a></li>
