...
<head>
  ...
  <link rel="stylesheet" href="/css/page.css?1.38">
  <link rel="stylesheet" href="/css/form.css?1.91">
...
<body class="">
  ...
  <div class="ttl bg_purple">
      <h2><i class="fas fa-store purple"></i>YouTube設定（SPOT）</h2>
      <a href="#" class="insert_btn btn type01  modal_btn bold"  data-name=".search_sec">新規登録</a>
    </div>
    ...
    <div class="page_info">
    <p>食材SPOTトップページのYouTube登録・編集ページ</p>
    </div>
    <!--page_info END-->
