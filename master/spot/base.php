...
<body id="spot">
  ...
  <div id="container" class="">
    ...
    <div id="" class="oneColumn itemBOX shadow">
      ...
      <h3 class="nextToggleBtn">会場の基本情報</h3>
      <p class="info">会場の名称や住所などの基本情報設定</p>
      ...
      <dl>
					<dt>営業時間の補足<span class="icon modal_btn" data-name=".exampleModal" data-filekey="use_time_long_text" >例文を見る</span></dt>
					<dd>
          <textarea class="mg_t10" name="use_time_long_text" placeholder="営業時間についての補足を入力してください。"></textarea>
					</dd>
      </dl>
      </div>
      ...
      <h3 class="nextToggleBtn">予約について</h3>
      <p class="info">予約・注文方法の設定</p>

      <div class="box table">

      <dl>
					<dt>予約方法<span class="icon modal_btn" data-name=".exampleModal" data-filekey="reserve" >例文を見る</span></dt>
					<dd>
				  	<input type="text" name="reservation_text" value="" placeholder="予約方法を入力してください。">
            <p class="font_11 mg_t5">例）要予約。まずはお電話ください。</p>
					</dd>
      </dl>
      ...
      <dl>
					<dt>予約用 電話番号</dt>
					<dd>
				  	<input type="text" name="reservation_tel" value="" class="iw_40" placeholder="">
					</dd>
      </dl>
      ...
      <dl>
					<dt>予約用ホームページURL</dt>
					<dd>
				  	<input type="text" name="reservation_url" value="" class="iw_40" placeholder="">
					</dd>
      </dl>
      ...
      <dl>
					<dt>予約用お問い合わせ先</dt>
					<dd>
				  	<input type="text" name="reservation_contact" value="" class="iw_40" placeholder="">
					</dd>
      </dl>
      </div>
      
      <h3 class="nextToggleBtn">詳細設定</h3>
      <p class="info">禁止事項・平均利用用金・施設の補足などの設定</p>

      <div class="box table">

      <dl>
					<dt>平均ご利用料金<span class="icon modal_btn" data-name=".exampleModal" data-filekey="average_fee">例文を見る</span></dt>
					<dd>
				  	<input type="text" name="price_text" value="" class="iw_40 inline" placeholder=""> 円
            <textarea class="mg_t10" placeholder="平均ご利用料金の補足を入力してください。"></textarea>
					</dd>
      </dl>

      <dl>
					<dt>施設について<span class="icon modal_btn" data-name=".exampleModal" data-filekey="institution" >例文を見る</span></dt>
					<dd>
				  	<input type="text" name="spot_text" value=""  placeholder="">
            <p class="font_11 mg_t5">※施設に関する補足事項</p>
					</dd>
      </dl>

      <dl>
					<dt>禁止事項<span class="icon modal_btn" data-name=".exampleModal" data-filekey="ban" >例文を見る</span></dt>
					<dd>
				  	<input type="text" name="ng_text" value=""  placeholder="">
            <p class="font_11 mg_t5">※花火や飲食持ち込みの有無など補足事項</p>
					</dd>
      </dl>

      <dl>
					<dt>ペットについて<span class="icon modal_btn" data-name=".exampleModal" data-filekey="pets" >例文を見る</span></dt>
					<dd>
				  	<input type="text" name="other_text" value=""  placeholder="">
            <p class="font_11 mg_t5">※ペットに関する補足事項</p>
					</dd>
      </dl>

      <dl>
					<dt>駐車場について<span class="icon modal_btn" data-name=".exampleModal" data-filekey="parking" >例文を見る</span></dt>
					<dd>
				  	<input type="text" name="parking_text" value="" placeholder="">
            <p class="font_11 mg_t5">※駐車場に関する補足事項</p>
					</dd>
      </dl>
