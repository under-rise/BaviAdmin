...
<head>
  ...
  <link rel="stylesheet" href="/css/login.css?1.3">
  <link rel="stylesheet" href="/css/form.css?1.4">
...
<div id="logo_sec">
    ...
    <h1 class="pink bold">オーナー管理ページ</h1>
</div>
...
<div class="login shadow">
  ...
  <form method="POST" action="/master/guest/select.php" class="form">
